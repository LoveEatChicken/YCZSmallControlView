...
@property (strong, nonatomic) ZYSplashViewController *splashVC;
...
- (void)showSplashView {
    ...
    _splashVC = [[ZYSplashViewController alloc] initWithNibName:@"ZYSplashViewController" bundle:nil];
    _splashVC.view.frame = self.window.bounds;
    [self.window addSubview:_splashVC.view];
    [_splashVC startSplashAnimation];
}
